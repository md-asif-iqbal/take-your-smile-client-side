    ...
    <div>
      <div className="bg-primary-content overflow-x-hidden sm:overflow-x-hidden">
        ...
        <p data-aos="fade-down"
          data-aos-easing="gradient(0,0,1000)"
          data-aos-duration="1500" style={{ color: "#c62127" }} className="text-center text-2xl mb-12">
          ...
          <div className="pb-9">
            <div className="w-3/4 mx-auto">
              ...
              >
                <div>
                  <SwiperSlide>
                    <img data-aos="zoom-out-right" data-aos-duration="3000" className="mx-auto" src={social1} alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img data-aos="zoom-out-right" data-aos-duration="3000" className="mx-auto" src={social2} alt="" />
                  </SwiperSlide>
                  <SwiperSlide>
                    <img data-aos="zoom-out-right" data-aos-duration="3000" className="mx-auto" src={social3} alt="" />
                  </SwiperSlide>
                </div>
              </Swiper>
            </div>
        ...
        <div className="py-16" style={{ backgroundColor: "#333333" }}>
          <h1 data-aos="fade-down"
            ...
            data-aos-duration="2100" className="text-neutral text-2xl pt-10 text-center pb-12">
            <strong>
              ...
              <div className="w-full text-neutral">
                <form action="">
                  <div data-aos="fade-down-right"
                    data-aos-easing="gradient"
                    data-aos-duration="1600" className="lg:flex">
                    <input
                  ...
                  <button data-aos="fade-up"
                    ...
                    data-aos-duration="1200" typeof="submit" className="send-button mx-3">
                    SEND
                  </button>
                </form>
              </div>
            ...
            <div className="pl-4">
              ...
              <div className="text-xl text-neutral">
                <p data-aos="fade-down-left"
                    data-aos-easing="gradient"
                    data-aos-duration="1800" className="pb-3">
                  <FontAwesomeIcon
                ...
                <p data-aos="fade-down-left"
                    data-aos-easing="gradient"
                    data-aos-duration="1600" className="pb-3">
                  <FontAwesomeIcon
                    className="text-primary pr-3"
                    icon={faAngleRight}
                  ></FontAwesomeIcon>{" "}
                ...
                <p data-aos="fade-down-left"
                    data-aos-easing="gradient"
                    data-aos-duration="1400" className="pb-3">
                  <FontAwesomeIcon
                    className="text-primary pr-3"
                    icon={faAngleRight}
                  ></FontAwesomeIcon>{" "}
                ...
                <p data-aos="fade-down-left"
                    data-aos-easing="gradient"
                    data-aos-duration="1200" className="pb-3">
                  <FontAwesomeIcon
                    className="text-primary pr-3"
                    icon={faAngleRight}
                  ></FontAwesomeIcon>{" "}
                ...
                <p data-aos="fade-down-left"
                    data-aos-easing="gradient"
                    data-aos-duration="1000" className="pb-3">
                  <FontAwesomeIcon
                    className="text-primary pr-3"
                    icon={faAngleRight}
                  ></FontAwesomeIcon>{" "}
              ...
              <p data-aos="fade-down-left"
                    data-aos-easing="gradient"
                    data-aos-duration="800" className="text-neutral text-xl mt-7">
