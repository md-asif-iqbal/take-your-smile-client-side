                                        ...
                                        <div className="flex justify-between items-center space-x-8  w-full">
                                            {
                                                paymentData?.status !== "paid" ?
                                                    < p className="text-base xl:text-lg leading-6 text-secondary">  <label htmlFor="my-modal-6" className="btn modal-button" onClick={() => handlePayment(item)}>Pay Now</label></p> :
                                                    < p className="text-base xl:text-lg leading-6 text-secondary">  <button className="btn btn-primary" >Paid</button></p>
                                            }
