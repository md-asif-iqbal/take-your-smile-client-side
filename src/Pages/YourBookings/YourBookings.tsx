        ...
        <div>
            ...
            <div className="py-14 mt-20 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
                ...
                <div className="flex justify-start item-start space-y-2 flex-col ">
                 ...
                 className="text-3xl lg:text-4xl font-semibold leading-7 lg:leading-9  text-secondary">Order #{orderNumber}</h1>
                </div>
                <div className="mt-10 flex flex-col xl:flex-row jusitfy-center items-stretch  w-full xl:space-x-8 space-y-4 md:space-y-6 xl:space-y-0">
                    <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                        <div className="flex flex-col justify-start items-start px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full font-mono">
                            <p data-aos="fade-up"
            data-aos-easing="gradient(0,0,1200)"
            data-aos-duration="1900"
             className="text-lg md:text-xl font-semibold leading-6 xl:leading-5 text-secondary font-mono mb-4">Customer’s Cart</p>
                                    ...
                                    data-aos-duration="3000"
                                     className="  flex justify-between items-start w-full flex-col md:flex-row space-y-4 md:space-y-0  ">
                                        <div className="w-full flex flex-col justify-start items-start space-y-2">
                                            <h3 className="text-xl xl:text-2xl font-semibold leading-6 text-secondary ">{item.service}</h3>
                                            <div className="flex justify-start items-start flex-col space-y-2">
                                                <p className="text-sm leading-none text-secondary">
                                                    <span className="text-secondary">Package: </span> {item.package}
                                                </p>
                                                <p className="text-sm leading-none text-secondary">
                                                    <span className="text-secondary">Location: </span> {item.location}
                                                </p>
                                                <p className="text-sm leading-none text-secondary">
                                                    <span className="text-secondary">Date: </span> {item.date}
                                                </p>
                                                <p className="text-sm leading-none text-secondary">
                                                    <span className="text-secondary">Time: </span> {item.time}
                                                </p>
                                            </div>
                                        </div>
                                        <div className="flex justify-between items-center space-x-8  w-full">
                                            ...
                                            <div className="modal mt-10">
                                                <div className="modal-box relative text-black bg-gray-100">
                                                    ...
                                                    <h3 className="text-lg font-bold">Are you sure to cancle {data.service}</h3>
                                                    <p className="py-4 ">
                ...
                data-aos-duration="3000" className="text-xl font-semibold leading-5 text-secondary">Summary</h3>
                                <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                                    <div className="flex justify-between  w-full">
                                        <p data-aos="flip-down"
                                           data-aos-duration="3000" 
                          className="text-base leading-4 text-secondary">Subtotal</p>
                                        <p data-aos="flip-down"
                data-aos-duration="3000" className="text-base leading-4 text-secondary">${total}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full space-y-6  font-mono">
                                <h3 data-aos="zoom-in-left"
                    data-aos-easing="gradient(0,0,1000)"
                    data-aos-duration="1700"
                     className="text-xl font-semibold leading-5 text-secondary" >You Are Ordering {booking.length} Service</h3>
                                <div className="flex justify-between items-start w-full">
                                    ...
                                    <p data-aos="flip-down"
                                           data-aos-duration="3000"
                                            className="text-lg font-semibold leading-6 text-secondary">${total}</p>
                                </div>
                    ...
                    <div className="w-full xl:w-96 flex justify-between items-center md:items-start px-4 py-6 md:p-6 xl:p-8 flex-col ">
                        <h3 
                         data-aos="flip-down"
                         data-aos-duration="3000"
                         className="text-xl font-semibold leading-5 text-secondary">Customer</h3>
                        <div className="flex  flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0 ">
                            <div className="flex flex-col justify-start items-start flex-shrink-0">
                                <div className="flex justify-center  w-full  md:justify-start items-center space-x-4 py-8 border-b border-gray-200">
                                    ...
                                    data-aos="zoom-in"
                                    data-aos-duration="3000" 
                                     className="w-20 rounded-[50%]" src={user?.photoURL} alt="avatar" />
                                    <div className=" flex justify-start items-start flex-col space-y-2">
                                        <p data-aos="flip-down"
                                        data-aos-duration="3000"
                                        className="text-base font-semibold leading-4 text-left text-secondary">{user?.displayName}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-center  md:justify-start items-center space-x-4 py-4 border-b border-gray-200 w-full">
                                    ...
                                    <p 
                                     ...
                                     data-aos-easing="ease-out-cubic"
                                     data-aos-duration="2000"
                                className="cursor-pointer text-sm leading-5 text-secondary">{user?.email}</p>
                                </div>
                            </div>
