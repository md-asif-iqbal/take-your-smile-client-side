                                ...
                                booking.map((item: any) => (<div className="mt-6 md:mt-0 flex justify-start flex-col md:flex-row  items-start md:items-center space-y-4  md:space-x-6 xl:space-x-8 w-full mb-5">
                                    ...
                                    <div className="  flex justify-between items-start w-full flex-col md:flex-row space-y-4 md:space-y-0  ">
                                        ...
                                        <div className="flex justify-between items-center space-x-8  w-full">
                                            ...
                                            <button> <label htmlFor="my-modal-3" onClick={() => setData(item.service)} className="bg-primary uppercase px-6 py-2 rounded text-white cursor-pointer">Cancle</label>
                                            </button>
                                            ...
                                            <div className="modal mt-10">
                                                <div className="modal-box relative text-black bg-gray-100">
                                                    ...
                                                    <h3 className="text-lg font-bold">Are you sure to cancle {data}</h3>
                                                    <p className="py-4 ">
