                ...
                <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                    ...
                    <div className="flex justify-center md:flex-row flex-col items-stretch w-full space-y-4 md:space-y-0 md:space-x-6 xl:space-x-8">
                        <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-primary-content space-y-6   ">
                            ...
                            <div className="flex justify-center items-center w-full space-y-4 flex-col border-secondary border-b pb-4">
                        ...
                        <div className="flex flex-col justify-center px-4 py-6 md:p-6 xl:p-8 w-full bg-primary-content space-y-6  font-mono">
                            ...
                            <div className="w-full flex justify-center items-center">
                                <button className="bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2  py-5 w-96 md:w-full text-base font-medium leading-4 text-white">Pay Now</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex  flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0 ">
                        <div className="flex flex-col justify-start items-start flex-shrink-0">
                            <div className="flex justify-center  w-full  md:justify-start items-center space-x-4 py-8 border-b border-gray-200">
                                <img className="w-20 rounded-[50%]" src={user?.photoURL} alt={(user?.displayName).split(' ')[0]} />
                                <div className=" flex justify-start items-start flex-col space-y-2">
                                    <p className="text-base font-semibold leading-4 text-left text-secondary">{user?.displayName}</p>
                                </div>
                            </div>

                            <div className="flex justify-center  md:justify-start items-center space-x-4 py-4 border-b border-gray-200 w-full text-secondary">
