...
<div className="2xl:mx-auto 2xl:container lg:px-20 lg:py-16 md:py-12 md:px-6 py-9 px-4 w-96 sm:w-auto">
  ...
  <h1 className="text-4xl font-semibold leading-9 text-center text-gray-800 dark:text-gray-50">This is Corporate-Events Gallery</h1>
  
         </div>
       <div className="lg:flex items-stretch md:mt-12 mt-8">
<div className="lg:w-1/2 xl:mr-8 lg:mr-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
    <div className="cardso">
      <div className='cardt'>
      <img src="https://i.ibb.co/6Wfjf2w/img-4.png" alt="sitting place" className="w-full sm:block" />
        <p className="md:p-10 p-6 text-xs font-medium leading-3 text-white absolute top-0 right-0">12 April 2021</p>
        <div className=" card-desc w-full  left-0 p-6">
            <div className='mt-72'>
    ...
    <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6 md:mt-6 mt-4">
      ...
      <div className="cardso w-full sm:mt-0 mt-4">
        <div className='cardt'>
  ...
  <div className="lg:w-1/2">
    <div className="sm:flex items-center justify-between xl:gap-x-8 gap-x-6">
      ...
      <div className="sm:w-1/2 sm:mt-0 mt-4 cardso">
        <div className='cardt'>
    ...
    <div className="cardso mt-8 md:mt-6">
      <div className='cardt'>
      <img src="https://i.ibb.co/Ms4qyXp/img-3.png" alt="sitting place" className="w-full w-full " />
        <p className="md:p-10 p-6 text-xs font-medium leading-3 text-white absolute top-0 right-0">12 April 2021</p>
        <div className=" card-desc w-full  left-0 p-6">
            <div className='mt-72'>
                    <h2 className="text-xl  font-semibold 5 text-white">The Decorated Ways</h2>
...
{/* second part */}
        ...
        <div className="lg:w-1/2">
            ...
            <div className="cardso mt-8 md:mt-6">
            <div className='cardt'>
            <img src="https://i.ibb.co/Ms4qyXp/img-3.png" alt="sitting place" className="w-full  " />
                <p className="md:p-10 p-6 text-xs font-medium leading-3 text-white absolute top-0 right-0">12 April 2021</p>
                <div className=" card-desc w-full  left-0 p-6">
                    <div className='mt-72'>
                            <h2 className="text-xl  font-semibold 5 text-white">The Decorated Ways</h2>
