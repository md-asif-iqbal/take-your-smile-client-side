				...
				<div className='rounded-lg h-auto pb-16 mb-16 mx-auto w-3/5 mt-36  bg-indigo-800 px-2'>
					...
					<div className='pb-2 px-2 '>
						<div className=' hover:bg-indigo-700 px-2 rounded-lg  py-2 mx-auto flex  '>
							...
							<p className='pl-2 text-gray-400 font-medium' style={{ display: 'flex', alignItems: 'center' }}><Link to='/admindashboard/allbookings/bookings'>All Bookings</Link></p>
						</div>
					</div>
					...
					<div className='pb-2 px-2 '>
						<div className=' hover:bg-indigo-700 px-2 rounded-lg  py-2 mx-auto flex  '>
							...
							<p className='pl-2 text-gray-400 font-medium' style={{ display: 'flex', alignItems: 'center' }}><Link to='/admindashboard/user'>All User</Link></p>
						</div>
					</div>
