...
const Sidebar = () => {
		...
		<div className="flex-1 justify-center">
			<ul  className="pt-2 pb-4 space-y-1 text-sm">
				...
				<li className="rounded-sm hover:shadow-md">
					<Link to="/dashboard/allbooking"  className="flex items-center p-2 space-x-3 rounded-md">
				...
				<li className="rounded-sm hover:shadow-md">
					<Link to="/dashboard/reviews" rel="noopener noreferrer" className="flex items-center p-2 space-x-3 rounded-md">
						...
						<span className='text-2xl'><VscOpenPreview/></span>
				...
				<li className="rounded-sm hover:shadow-md">
					<Link to="/dashboard/admin" rel="noopener noreferrer"  className="flex items-center p-2 space-x-3 rounded-md">
						
						<span className='text-2xl'><MdOutlineAdminPanelSettings/></span>
						<span style={{display: `${sidebar}`}}>Admin</span>
					</Link>
				</li>
				<li className="rounded-sm hover:shadow-md">
					<Link to="/dashboard/users" rel="noopener noreferrer" className="flex items-center p-2 space-x-3 rounded-md">
						
						<span className='text-2xl'><BiUserCircle/></span>
						<span style={{display: `${sidebar}`}}>All Users</span>
					</Link>
				</li>
	...
	<div className="flex items-center p-2 mt-12 space-x-4 justify-self-end">
		...
		<div>
			<h2 className="text-lg font-semibold" style={{display: `${sidebar}`}}>Leroy Jenkins</h2>
			<span className="flex items-center space-x-1">
				<a style={{display: `${sidebar}`}} rel="noopener noreferrer" href="#" className="text-xs hover:underline dark:text-gray-400">View profile</a>
			</span>
		</div>
	</div>
</div>
