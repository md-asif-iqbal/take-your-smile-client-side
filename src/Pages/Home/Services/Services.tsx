...
const Services = () => {
    return (
        <div className='container mx-auto my-10 px-2'>
            ...
            <h2 className='text-2xl font-bold capitalize text-primary dark:text-white md:text-2xl lg:text-4xl my-5'>Our Services</h2>
        ...
        <div className='grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-gray-500 px-2'>
            <div className="card min-w-1/4 shadow-xl">
            ...
            <div className="card-body">
                <h2 className="card-title text-center justify-center mb-5">Corporate Events</h2>
            ...
            <div className="card-body">
                <h2 className="card-title justify-center mb-5 text-center">Weddings</h2>
