...
const Services = () => {
    return (
        <div className='container mx-auto my-10 px-2'>
            ...
            <h2 className='text-2xl font-bold capitalize text-rose-500 md:text-2xl lg:text-4xl my-5'>Our Services</h2>
        ...
        <div className='grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-gray-500 px-2'>
            ...
            <div className="card-body">
                ...
                <button className="btn btn-rose capitalize mt-10 btn-block text-lg">details</button>
                </div>
            </div>
            </div> 
            <div className="card min-w-1/4 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <p className=''><span className='inline-block text-rose-500'><TiTick /></span>Talent Show</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span>Concert </p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Conferences</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Trade Shows</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Customer Appreciation Parties</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Customer Appreciation Parties</p>
            ...
            <div className="card-body">
                ...
                <p className=''><span className='inline-block text-rose-500'><TiTick /></span> Award ceremonies</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Birthday Parties</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Anniversary Parties</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Retirement Parties</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Seasonal Celebrations</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Religious events</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span>Photography</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span>more...</p>
            ...
            <div className="card-body">
                ...
                <p className=''><span className='inline-block text-rose-500'><TiTick /></span>Wedding Ceremony </p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Floral Design </p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Receptions</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span> Rehearsal Dinners</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span>Engagement Parties</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span>Photography</p>
                <p><span className='inline-block text-rose-500'><TiTick /></span>more...</p>
