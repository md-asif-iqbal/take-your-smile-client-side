...
import UseFashionDe from "../../../../hooks/Decration/Corporate/UseFashionDe";
...
const FashionFrom = () => {
  ...
  console.log(packag);
  const { fas } = useParams();
  const [FashionDe] = UseFashionDe(fas);
  console.log(FashionDe);
  const { id } = useParams();
