...
import UseProductDe from "../../../../hooks/Decration/Corporate/UseProductDe";
...
const ProductForm = () => {
  ...
  const { pro } = useParams();
  const [product] = UseProductDe(pro);
  const { id } = useParams();
              ...
              <form className="p-7" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="lg:flex w-full">
                  ...
                  <div className="form-control">
                    ...
                    >
                      <option index className="font-mono text-lg text-black">Morning</option>
                      <option className="font-mono text-lg text-black">AfterNoon</option>
                      <option className="font-mono text-lg text-black">Night</option>
                    </select>
                  </div>
                </div>
                <div className="lg:flex w-full">
