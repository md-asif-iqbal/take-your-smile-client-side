...
import UseEducationDe from "../../../../hooks/Decration/Corporate/UseEducationDe";
const Educationafrom = () => {
  ...
  console.log(packag);
  const { edu } = useParams();
  const [educational] = UseEducationDe(edu);
  const { id } = useParams();
