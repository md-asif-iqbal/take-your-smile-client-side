...
import UseFloralde from "../../../../hooks/Decration/Wedding/UseFloralde";
const FloralFrom = () => {
  ...
  const [floralDesign]: any = UseFloralde(flow);
  console.log(packag);
  const { id } = useParams();
  ...
  const onSubmit: SubmitHandler<Inputs> = (data) => {
    const booking = {
      ...
      email: user?.email,
      decrImg1: floralDesign.decImg,
      decrImg2: floralDesign.decImg1,
      decrImg3: floralDesign.decImg2,
