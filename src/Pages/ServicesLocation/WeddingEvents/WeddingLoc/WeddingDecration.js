...
const WeddingDecration = () => {
  ...
  useEffect(() => {
    const url = "http://localhost:8000/weddingceremony";
    fetch(url)
      .then((res) => res.json())
  ...
  const handleClick = (item, pack, id) => {
    navigate(`/weddOrder/${pack}/${id}/${item}`);
  };
  return (
    <>
      <div className="z-10">
...
export default WeddingDecration;
