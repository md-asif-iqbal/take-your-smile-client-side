...
import UseWeddingDec from "../../../../hooks/Decration/Wedding/UseWeddingDec";
...
const WeddingForm = () => {
  ...
  const [weddings] = UseWeddingDec(wedd);
  ...
  const onSubmit = (data) => {
    const bookingData = {
      ...
      email: user?.email,
      decrImg1: weddings.decImg,
      decrImg2: weddings.decImg,
      decrImg3: weddings.decImg,
