...
const Posts = () => {
  ...
  const handleCommentPost = (e) => {
    ...
    const url = `https://take-your-smile-server-side.onrender.com/comments/${postId}`;

    axios
      .post(
        `https://take-your-smile-server-side.onrender.com/comments/${postId}`,
        update
      )
  ...
  const handleComments = (id) => {
    ...
    if (showComment !== "show") {
      ...
      const url = `https://take-your-smile-server-side.onrender.com/allposts/${id}`;
      fetch(url, {
        method: "PUT",
        headers: {
  ...
  return (
    <div>
      ...
      <div className="text-neutral mx-auto font-sans  mt-36">
        <h1 className="text-black text-3xl text-center mt-16 font-bold opacity-60 underline">
          All <span style={{ color: "red" }}>Blogs</span> Here
        </h1>
        ...
        <section className=" body-font">
          <div
            ...
            className="container px-5 mx-auto  py-24 "
          >
                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    <div className="card-actions justify-end relative">
                      ...
                      >
                        <ShareSocial posts={posts}></ShareSocial>
                      </div>
                    </div>
                    ...
                    <label
                      ...
                      htmlFor="my-modal-6"
                      className="modal-button text-right underlineText cursor-pointer"
                    >
                      {" "}
                      Show all comments
                    </label>
            ...
            <div className="modal-box relative">
              ...
              <div className="bg-white rounded-md">
                {post?.comments?.map((c) => (
                  <div>
                    <div
                      className="mb-2 rounded-md text-black py-1"
              ...
              >
                ...
                <p className="text-right mt-2">
                  ...
                  <button
                    type="submit"
                    className=" py-3 px-2 rounded-md btn"
                    style={{}}
                  >
                    POST
                  </button>
