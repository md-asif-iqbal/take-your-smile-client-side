...
const Payment = () => {
  return (
    <div data-aos="fade-down-left" data-aos-duration="1300" className="w-full overflow-x-hidden sm:overflow-x-hidden lg:-mt-96 mb-60 lg:w-2/5 px-8 py-12 ml-auto bg-primary  rounded-2xl">
