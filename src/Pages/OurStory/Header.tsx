...
const Header = () => {
  return (
    <>
      <h1 className="background-set mt-24 text-primary text-2xl font-semibold text-center italic mb-20">
        Love Story
      </h1>
      <div className="w-11/12 font-mono md:w-8/12 mx-auto grid grid-cols-1 md:grid-cols-2 gap-5">
        <img src={headImg} className="mx-auto" alt="" />
        <div className="text-center text-md">
          ...
          <h1 className="mt-2 text-lg italic font-bold text-primary">
            Amelia & Tim
          </h1>
        </div>
      </div>
