...
const Footer = () => {
  ...
  <div>
    ...
    <p>Take Your Smile.<br/>Your smile, our first priority</p>
  </div> 
  <div>
    <span className="footer-title">Services</span> 
    <a className="link link-hover" href="a">Branding</a> 
    <a className="link link-hover" href="a">Design</a> 
    <a className="link link-hover" href="a">Marketing</a> 
    <a className="link link-hover" href="a">Advertisement</a>
  </div> 
  <div>
    <span className="footer-title">Company</span> 
    <a className="link link-hover" href="a">About us</a> 
    <a className="link link-hover" href="a">Contact</a> 
    <a className="link link-hover" href="a">Jobs</a> 
    <a className="link link-hover" href="a">Press kit</a>
  </div> 
  <div>
    <span className="footer-title">Legal</span> 
    <a className="link link-hover" href="a">Terms of use</a> 
    <a className="link link-hover" href="a">Privacy policy</a> 
    <a className="link link-hover" href="a">Cookie policy</a>
  </div>
</footer>
  );
};
